...
//
//	mockgen -destination=namespace_service_mock_test.go -package=services -self_package=github.com/Stackdome/stackdome/pkg/services github.com/Stackdome/stackdome/pkg/services NamespaceService
//
...
func (m *MockNamespaceService) InjectClusterResourceServiceDeps(deps ClusterResourceServiceDeps) {
	m.ctrl.T.Helper()
