...
// Source: pkg/services/compute_access_service.go
//
// Generated by this command:
//
//	mockgen -source=pkg/services/compute_access_service.go -destination=pkg/services/compute_access_service_mock.go -package=services -self_package=github.com/Stackdome/stackdome/pkg/services
//
...
func (m *MockComputeAccessService) RequireAccess(ctx context.Context, organisationID string) (*models.ComputeAccess, *errors.ServiceError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RequireAccess", ctx, organisationID)
	ret0, _ := ret[0].(*models.ComputeAccess)
	ret1, _ := ret[1].(*errors.ServiceError)
	return ret0, ret1
}
...
func (mr *MockComputeAccessServiceMockRecorder) RequireAccess(ctx, organisationID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RequireAccess", reflect.TypeOf((*MockComputeAccessService)(nil).RequireAccess), ctx, organisationID)
}
