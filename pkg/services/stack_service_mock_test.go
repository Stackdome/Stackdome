...
//
//	mockgen -destination=pkg/services/stack_service_mock_test.go -package=services -self_package=github.com/Stackdome/stackdome/pkg/services github.com/Stackdome/stackdome/pkg/services StackService
//
...
func (m *MockStackService) InjectClusterResourceServiceDeps(deps ClusterResourceServiceDeps) {
	m.ctrl.T.Helper()
