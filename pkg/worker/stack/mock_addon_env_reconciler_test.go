...
// Source: pkg/worker/stack/connection_reconciler.go
//
// Generated by this command:
//
//	mockgen -source=pkg/worker/stack/connection_reconciler.go -destination=pkg/worker/stack/mock_addon_env_reconciler_test.go -package=stack
//
