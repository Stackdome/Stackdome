...
// Source: pkg/worker/release/types.go
//
// Generated by this command:
//
//	mockgen -source=pkg/worker/release/types.go -destination=pkg/worker/release/types_mock.go -package=release
//
...
func (m *MockreleaseService) InternalGetLatestByStackID(ctx context.Context, stackID string) (*models.StackRelease, *errors.ServiceError) {
	m.ctrl.T.Helper()
...
func (mr *MockreleaseServiceMockRecorder) InternalGetLatestByStackID(ctx, stackID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InternalGetLatestByStackID", reflect.TypeOf((*MockreleaseService)(nil).InternalGetLatestByStackID), ctx, stackID)
}
...
// RequireComputeAccess mocks base method.
func (m *MockruntimePolicy) RequireComputeAccess(ctx context.Context, organisationID string) *errors.ServiceError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RequireComputeAccess", ctx, organisationID)
	ret0, _ := ret[0].(*errors.ServiceError)
	return ret0
}

// RequireComputeAccess indicates an expected call of RequireComputeAccess.
func (mr *MockruntimePolicyMockRecorder) RequireComputeAccess(ctx, organisationID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RequireComputeAccess", reflect.TypeOf((*MockruntimePolicy)(nil).RequireComputeAccess), ctx, organisationID)
}
