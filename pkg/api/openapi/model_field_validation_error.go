...
func (v NullableFieldValidationError) Get() *FieldValidationError {
	return v.value
}

func (v *NullableFieldValidationError) Set(val *FieldValidationError) {
	v.value = val
	v.isSet = true
}

func (v NullableFieldValidationError) IsSet() bool {
	return v.isSet
}
...
func NewNullableFieldValidationError(val *FieldValidationError) *NullableFieldValidationError {
	return &NullableFieldValidationError{value: val, isSet: true}
}
