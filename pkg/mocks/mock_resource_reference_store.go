...
// Source: pkg/stores/resource_reference_store.go
//
// Generated by this command:
//
//	mockgen -source=pkg/stores/resource_reference_store.go -destination=pkg/mocks/mock_resource_reference_store.go -package=mocks
//
