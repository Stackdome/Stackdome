...
// Source: pkg/stores/stack_release_store.go
//
// Generated by this command:
//
//	mockgen -source=pkg/stores/stack_release_store.go -destination=pkg/mocks/mock_stack_release_store.go -package=mocks
//
...
func (m *MockStackReleaseStore) LockByID(ctx context.Context, id string) *errors.ServiceError {
	m.ctrl.T.Helper()
...
func (mr *MockStackReleaseStoreMockRecorder) LockByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LockByID", reflect.TypeOf((*MockStackReleaseStore)(nil).LockByID), ctx, id)
}
