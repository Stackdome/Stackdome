...
This is an eventually consistent loop. An accepted deploy means the desired state was recorded; a terminal release state such as `ready` or `failed` tells you how reconciliation finished.
