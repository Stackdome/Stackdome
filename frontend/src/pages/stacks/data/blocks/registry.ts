...
export const blockCatalog: BlockPreset[] = [
  ...
  {
    id: BlockId.Mongo, name: "MongoDB", category: "data", icon: "mongo", summary: "mongo:7 · :27017",
    compose: [
  ...
  {
    id: BlockId.Elasticsearch, name: "Elasticsearch", category: "data", icon: "elasticsearch", summary: "elasticsearch:8 · :9200",
    compose: [
  ...
  {
    id: BlockId.Influxdb, name: "InfluxDB", category: "data", icon: "influxdb", summary: "influxdb:2.7 · :8086",
    compose: [
