...
interface EnvAddonGroupProps {
  ...
  onDetach?: () => void;
  onCancelDetach?: () => void;
  onChangeBinding?: (oldCredField: AddonOutputField | undefined, newCredField: AddonOutputField) => void;
  onRemoveBinding?: (credField: AddonOutputField | undefined, envName: string) => void;
}
            ...
            >
              ...
              {showRebind ? (
                <Select
                  ...
                  onValueChange={(v) => {
                    onChangeBinding?.(b.credField, v as AddonOutputField);
                ...
                >
                  ...
                  <SelectContent>
                    {ADDON_OUTPUT_FIELDS.filter((f) => f !== b.credField).map((f) => (
